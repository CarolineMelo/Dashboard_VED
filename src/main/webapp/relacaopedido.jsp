                                                ...
                                                <table class="table mt-5  ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td id = "dinheiro " >R$ ${Pedido.total}</td>
                                                        </tr>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card my-4">
                                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                                <h6 class="text-white text-capitalize ps-3">Dados do Cliente</h6>
                                            </div>
                                            <div class="container overflow-scroll over ">
                                                <table class="table mt-5 ">
                                                    <thead class="thead-dark">
                                                        ...
                                                        <c:forEach var="Produtos" items="${ListaProduto}">
                                                            <tr class="text-center">
                                                             <input type="hidden" name="id" value="${ListaProduto}" />
                                                                ...
                                                                <td id = "dinheiro ">R$ ${Produtos.preco}</td>
                                                                <td id = "dinheiro ">R$ ${Produtos.preçoTI}</td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>
