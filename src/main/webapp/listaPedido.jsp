                  ...
                  <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                      <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Tabela de Pedido</h6>
                      </div>
                    </div>
                              ...
                              <form action="ServletPedido" method="post">
                                <tr class="text-center">
                                  ...
                                  <c:set var="d1" value="${pedido.data}"/>
	                                   <td> <fmt:formatDate pattern = "dd-MM-yyyy" value="${d1}"/></td> 
                                  <td>${pedido.quantidade}</td>
                                  <td>R$ ${pedido.valor_total}</td>
                                    <td>                                  
	                                   <button type="submit" name="option" value="informacao" class="btn  btn-success btn-outline-success	">
