            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">cadastro Marca
                        </li>
                    </ol>
                ...
                <div class="col-md-5 mx-auto border text-center">
                    ...
                    <form method="post" action="ServletMarca">
                        ...
                        <div class="form-group"">
                            <input type="text" class="form-control border " style=" background-color: rgb(255, 255, 255);" name="descricao" value="${marca.descricao}"
                                required>
                        </div>
