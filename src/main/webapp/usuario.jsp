                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                            href="#">Paginas</a></li>
                                    <li class="breadcrumb-item text-sm text-dark " aria-current="page">Usuarios</li>
                                </ol>
                                <h1 class="-bolder mb-0">Usuarios</h1>
                                    ...
                                    <div class="card my-4">
                                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                                <h6 class="text-white text-capitalize ps-3">Tabela de Usuarios Cadastrados</h6>
                                            </div>
                                        </div>
                                                            ...
                                                            <form action="ServletUsuario" method="post">
                                                                <tr  class="text-center">
                                                                    ...
                                                                    <div class="modal fade"
                                                                        id="modelDelete-${usuario.id}" tabindex="-1"
                                                                        aria-labelledby="modelDeleteLabel"
                                                                        aria-hidden="true">
