                    ...
                    <form method="post" action="ServletFornecedor">
                        ...
                        <div class="form-group" style="text-align-last: left;">
                            ...
                            <input type="text" class="form-control" name="razao_social"
                                value="${fornecedor.razao_social}"  style=" background-color: rgb(255, 255, 255);"required>
                        </div>
                        <div class="form-group" style="text-align-last: left;">
                            <label for="nome" class="form-label">CNPJ:</label>
                            <input type="text" class="form-control" style=" background-color: rgb(255, 255, 255);" name="cnpj" value="${fornecedor.cnpj}" id="cnpj" required>
                        </div>
                        <div class="form-group" style="text-align-last: left;">
                            <label for="nome" class="form-label">E-mail:</label>
                            <input type="text" class="form-control"  style=" background-color: rgb(255, 255, 255);" name="email" value="${fornecedor.email}" required>
                        </div>
